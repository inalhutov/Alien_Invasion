...
pygame.mixer.init()
pygame.mixer.music.load('music/PGM.wav')
pygame.mixer.music.play(-1)
boom = pygame.mixer.Sound('music/boom2.wav')
sht = pygame.mixer.Sound('music/Shot.wav')
background_image = pygame.image.load('images/mainfon.jpg')
